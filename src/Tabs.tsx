...
const steps: Array<Step> = [
    ...
    {
        target: '.banner',
        content: 'Это один из блоков твоего сайта! Ты можешь его переместить в более подходящее место! Или двойным кликом его отредактировать! Распологай их так, чтобы на них чаще кликали посетители!',
        disableBeacon: true,
    },
    {
        target: '#center',
